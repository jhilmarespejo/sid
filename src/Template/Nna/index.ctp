    ...
    <table class="table table-responsive display dataTable cell-border table-hover" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('CASO'), ['controller' => 'affairs','action' => 'send', $nna->id, 'affairs'], ['class' => '']) ?>
                    <!-- <?= $this->Html->link(__('View'), ['action' => 'view', $nna->id]) ?> -->
                    <br/>
                    <?= $this->Html->link(__('AGREGAR ARCHIVOS'), ['controller' => 'files', 'action' => 'add', $nna->id, 'files'], ['class' => '']) ?>
