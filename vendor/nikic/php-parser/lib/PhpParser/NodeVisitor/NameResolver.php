...
class NameResolver extends NodeVisitorAbstract
{
    ...
    /** @var array Map of format [aliasType => [aliasName => nnanames]] */
    protected $aliases;
     ...
     *
     * Options: If "preserveOriginalNames" is enabled, an "nnanames" attribute will be added to
    ...
    protected function resolveClassName(Name $name) {
        if ($this->preserveOriginalNames) {
            ...
            $nnanames = $name;
            $name = clone $nnanames;
            $name->setAttribute('nnanames', $nnanames);
        }
